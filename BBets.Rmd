...
In conclusion, by repeating Brownlow's 1137 wagers 100 times, we estimated an average profit of $`r round(mean(betarray))`. It is important to note that the number of students in the class, as well as the amount Brownlow wagered, influenced the earnings.
